...
The OpenAPI contract contains 149 operations across 113 paths. The Postman
...
| ------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| Identity/session                | registration, verification-request enumeration safety, password login/cookie, typed passkey options/credentials, safe owned-passkey listing/deletion, logout, unverified denial, login throttle | `identity-http.integration-spec.ts`, `identity-access.integration-spec.ts`, passkey unit/OpenAPI tests    |
