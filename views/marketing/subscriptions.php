...
?>
<div class="space-y-16 bg-gray-100 pb-24">
  <header class="px-6 pt-16 text-center">
    <div class="mx-auto max-w-4xl space-y-6">
      <p class="text-sm font-semibold uppercase tracking-[0.28em] text-gray-500"><?= __('Memberships designed for peace of mind') ?></p>
      ...
      <div class="flex flex-wrap justify-center gap-4">
        <a href="/register" class="btn btn-primary px-6 py-3 text-base">
  ...
  <section class="px-6">
    <div class="mx-auto grid max-w-5xl gap-6 lg:grid-cols-[1.05fr_minmax(0,0.95fr)]">
      <article class="space-y-6 rounded-3xl border border-gray-200 bg-white p-10 shadow-sm">
        ...
        <div class="space-y-4 rounded-2xl border border-gray-100 bg-gray-50 p-6 text-sm text-gray-600">
          <p class="font-semibold text-gray-900"><?= __('Included wellbeing tools') ?></p>
          <ul class="space-y-3">
            <li class="flex items-start gap-3">
              <span class="mt-1 text-gray-700"><i data-lucide="sun" class="h-4 w-4"></i></span>
              <span><?= __('Morning focus and gratitude prompts synced to your budget view.') ?></span>
            </li>
            <li class="flex items-start gap-3">
              <span class="mt-1 text-gray-700"><i data-lucide="smile-plus" class="h-4 w-4"></i></span>
              <span><?= __('Mood-aware nudges that reduce overspending stress.') ?></span>
            </li>
            <li class="flex items-start gap-3">
              <span class="mt-1 text-gray-700"><i data-lucide="book" class="h-4 w-4"></i></span>
      ...
      <article class="space-y-6 rounded-3xl border border-gray-900 bg-gray-900/95 p-10 text-white shadow-xl">
        <header class="space-y-2">
          <p class="text-sm font-semibold uppercase tracking-[0.28em] text-gray-300"><?= __('Best value yearly') ?></p>
          <h2 class="text-3xl font-semibold"><?= __('MoneyMap Plus Annual') ?></h2>
          <p class="text-sm text-gray-200"><?= __('Save two months and deepen your rituals with seasonal guidance and exclusive resources.') ?></p>
        </header>
        ...
        <ul class="space-y-4 text-sm text-gray-200">
          ...
          <li class="flex items-start gap-3">
            <span class="mt-1"><i data-lucide="calendar-heart" class="h-4 w-4"></i></span>
          ...
          <li class="flex items-start gap-3">
            <span class="mt-1"><i data-lucide="shield-check" class="h-4 w-4"></i></span>
            <span><?= __('Priority encrypted support with proactive wellbeing check-ins.') ?></span>
          </li>
        </ul>
        <div class="space-y-4 rounded-2xl border border-gray-800 bg-gray-900 p-6 text-sm text-gray-200">
          ...
          <ul class="space-y-3">
            ...
            <li class="flex items-start gap-3">
              <span class="mt-1"><i data-lucide="medal" class="h-4 w-4"></i></span>
  ...
  <section class="px-6">
    <div class="mx-auto max-w-4xl space-y-12 rounded-3xl border border-gray-200 bg-white px-10 py-14 shadow-xl">
      <div class="space-y-3 text-center">
        <p class="text-sm font-semibold uppercase tracking-[0.28em] text-gray-500"><?= __('What you receive') ?></p>
